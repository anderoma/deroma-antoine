...
PackeryDocs.hero=function(e){"use strict";function t(e,a){if(!(e.maxY>a)){for(var n=document.createDocumentFragment(),o=[],i=0;i<4;i++){var d=r();o.push(d),n.appendChild(d)}e.element.appendChild(n),e.appended(o),setTimeout(function(){t(e,a)},40)}}function r(){var e=document.createElement("div");return e.className="hero__grid__item",e.style.width=Math.round(Math.random()*Math.random()*110+20)+"px",e.style.height=Math.round(Math.random()*Math.random()*90+20)+"px",e}var a=e.querySelector(".hero__grid"),n=new Packery(a,{itemSelector:".hero__grid__item",stamp:".hero__grid__stamp",gutter:2,containerStyle:null});t(n,e.offsetHeight+40)};
PackeryDocs.notification=function(t){"use strict";function n(){var t=new Date,n=e(t.getMinutes()),o=e(t.getSeconds());return[t.getHours(),n,o].join(":")}function e(t){return t<10?"0"+t:t}function o(){t.style[c]="opacity 1.0s",t.style.opacity="0"}var i,s=document.documentElement,c="string"==typeof s.style.transition?"transition":"WebkitTransition";PackeryDocs.notify=function(e){t.textContent=e+" at "+n(),t.style[c]="none",t.style.display="block",t.style.opacity="1",clearTimeout(i),i=setTimeout(o,1e3)}};
...
PackeryDocs["drag-item-positioned"]=function(e){"use strict";var i=e.querySelector(".grid"),n=new Packery(i,{columnWidth:100});n.getItemElements().forEach(function(e){var i=new Draggabilly(e);n.bindDraggabillyEvents(i)}),n.on("dragItemPositioned",function(e){PackeryDocs.notify("Packery drag positioned")})};
